...
contract Deploy is Deployer {
    ...
    function _proxies() internal view returns (Types.ContractSet memory proxies_) {
        proxies_ = Types.ContractSet({
            ...
            OptimismMintableERC20Factory: artifacts.getAddress("L1OptimismMintableERC20FactoryProxy"),
    ...
    function _impls() internal view returns (Types.ContractSet memory impls_) {
        impls_ = Types.ContractSet({
            ...
            OptimismMintableERC20Factory: artifacts.getAddress("L1OptimismMintableERC20FactoryImpl"),
    ...
    function deployImplementations(bool _isInterop) public {
        ...
        ChainAssertions.checkL1OptimismMintableERC20Factory({ _contracts: impls, _isProxy: false });
    ...
    function deployOpChain() public {
        ...
        /// Save both names for backwards compatibility
        artifacts.save("OptimismMintableERC20FactoryProxy", address(deployOutput.optimismMintableERC20FactoryProxy));
        artifacts.save("L1OptimismMintableERC20FactoryProxy", address(deployOutput.optimismMintableERC20FactoryProxy));
