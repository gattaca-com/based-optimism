...
contract SuperchainConfig is Initializable, ISemver {
    ...
    /// @notice The address of the upgrader, which can trigger upgrades of L2 Predeploys.
    ///         It can only be modified by an upgrade.
    ...
    /// @param _upgrader    Address of the upgrader, can upgrade L2 Predeploys through the OptimismPortal.
