...
func AddGameType(ctx context.Context, cfg AddGameTypeConfig) (AddGameTypeOutput, []broadcaster.CalldataDump, error) {
	var output AddGameTypeOutput
	...
	output, err = opcm.RunScriptSingle[AddGameTypeInput, AddGameTypeOutput](
		l1Host,
		cfg.Input,
		"AddGameType.s.sol",
		"AddGameType",
